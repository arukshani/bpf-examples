...
cd /home/dathapathu/emulator/github_code/bpf-examples/opera-v3-per-q
cd /home/dathapathu/emulator/github_code/bpf-examples/opera-v3-debugging

sudo ethtool -L ens4 combined 1

sudo taskset --cpu-list 11 ./scenario_3 10.1.0.1 configs/node-1-link.csv /dev/ptp0 120 1 1 
sudo taskset --cpu-list 11 ./scenario_3 10.1.0.2 configs/node-2-link.csv /dev/ptp0 120 1 1 
```
