...
static int process_rx_packet(void *data, struct port_params *params, uint32_t len, u64 addr)
{
	...
	if (is_veth == 0)
	{
		...
		unsigned char out_eth_src[ETH_ALEN+1] = { 0xec, 0x0d, 0x9a, 0x68, 0x21, 0x84}; //ec:0d:9a:68:21:84
		unsigned char out_eth_dst[ETH_ALEN+1] = { 0xec, 0x0d, 0x9a, 0x68, 0x21, 0xb0}; //ec:0d:9a:68:21:b0
