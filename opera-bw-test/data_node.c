...
int main(int argc, char **argv)
{
    ...
    setRouteElement(A, 1, 0, 1); //ip, topo, port
    ...
    setMacElement(B, 0, 0, dest_mac1); //port, topo, mac
    setMacElement(B, 0, 1, dest_mac1); //port, topo, mac
    setMacElement(B, 1, 0, dest_mac2); //port, topo, mac
