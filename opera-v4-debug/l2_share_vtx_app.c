...
int main(int argc, char **argv)
{
	...
	//VETH TX THREADS
    int veth_tx_threads_start_index = total_nic_threads;
    int veth_tx_threads_end_point = total_nic_threads + veth_port_count;
    ...
    //VETH RX THREADS
    int veth_rx_threads_start_index = veth_tx_threads_end_point;
    start_index_for_veth_ports  = n_nic_ports;
    ...
    for (i = veth_rx_threads_start_index; i < n_threads; i++)
	{
		struct thread_data *t = &thread_data[i];
